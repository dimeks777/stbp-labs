...
if __name__ == '__main__':
    ...
    text = 'Hello world'
    mnemonic = 'achieve acoustic advance agree airport bird brave bridge broccoli correct donate element'
    # mnemonic = 'врешті ясний процес тяжко назустріч закричати закричати вдома отримати четвертий документ воля'
    # mnemonic = 'безпека безпека безпека безпека безпека безпека безпека безпека безпека безпека безпека вогник'
    ...
    encrypted_text = encrypt(text.encode(), mnemonic)
